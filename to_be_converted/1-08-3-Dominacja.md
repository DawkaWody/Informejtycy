...
NIE
```
Wyjaśnienie do przykładu: litera W wystąpiła 2 razy, tyle samo razy co litera k. Niemniej jednak, litera k jest jedną z liter występujących największą liczbę razy, więc Bajtek nie jest zadowolony.
